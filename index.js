...
function nextQuestion(){
    ...
    for(let i = 0; i < options.length; i++){
        if(options[i].checked){
            ...
            let userAnswer = currentQuiz[indexes - 1][`option${selected}`];
            let correctAnswer = currentQuiz[indexes - 1].correctOption; 
    ...
    if(indexes > currentQuiz.length - 1){
        ...
        option2.innerText = currentQuiz[indexes].option2;
        option3.innerText = currentQuiz[indexes].option3;
        indexes++;
    }
}
